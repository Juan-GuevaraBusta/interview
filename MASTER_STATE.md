...
Current Day: 1 (~5h remaining — ACCELERATED)
...
| Block | Time | What |
|---|---|---|
| ahora | 40m | useRef + useMemo + useCallback (1 H) |
| | 25m | Render + Context (G only) |
| | 70m | Async P0 |
| | 50m | API integration |
| | 50m | Mini mock |
...
TS P0. React through useEffect (G 8, H 8.5). Forms 8.5.
